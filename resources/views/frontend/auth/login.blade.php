                    ...
                    <div class="well">
                        ...
                        <form action="{{ route('register') }}" method="POST">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input class="span3" type="password" name="password_confirmation" placeholder="Confirm Password">
                                </div>
                            </div>
                            <div class="controls">
                    ...
                    <div class="well">
                        ...
                        <form action="{{ route('access') }}" method="POST">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input class="span3" name="email" required type="text" placeholder="Email">
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="inputPassword">Password</label>
                                <div class="controls">
                                    <input type="password" required name="password" class="span3" placeholder="Password">
                                </div>
                            </div>
                            <div class="control-group">
                                <div class="controls">
