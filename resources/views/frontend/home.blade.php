                            ...
                            <ul class="thumbnails">
                                <li class="span3">
                                    <div class="thumbnail">
                                        ...
                                        <a href="product_details.html"><img
                                                src="{{asset('frontend/assets/img/bootstrap-ring.png')}}"
                                ...
                                <li class="span3">
                                    <div class="thumbnail">
                                        ...
                                        <a href="#" class="tag"></a>
                                        <a href="product_details.html"><img
                                                src="{{asset('frontend/assets/img/i.jpg')}}" alt=""></a>
                                    </div>
                                </li>
                                <li class="span3">
                                    <div class="thumbnail">
                                        ...
                                        <a href="#" class="tag"></a>
                                        <a href="product_details.html"><img
                                                src="{{asset('frontend/assets/img/g.jpg')}}" alt=""></a>
                                    </div>
                                </li>
                                <li class="span3">
                                    <div class="thumbnail">
                                        <a class="zoomTool" href="product_details.html"
                                            title="add to cart"><span class="icon-search"></span> QUICK VIEW</a>
                                        <a href="product_details.html"><img
                                                src="{{asset('frontend/assets/img/s.png')}}" alt=""></a>
                                    </div>
                                </li>
                            </ul>
                        </div>
                                ...
                                <li class="span3">
                                    <div class="thumbnail">
                                        <a class="zoomTool" href="product_details.html"
                                            title="add to cart"><span class="icon-search"></span> QUICK VIEW</a>
                                        <a href="product_details.html"><img
                                                src="{{asset('frontend/assets/img/f.jpg')}}" alt=""></a>
                                    </div>
                                </li>
                                <li class="span3">
                                    <div class="thumbnail">
                                        <a class="zoomTool" href="product_details.html"
                                            title="add to cart"><span class="icon-search"></span> QUICK VIEW</a>
                                        <a href="product_details.html"><img
                                                src="{{asset('frontend/assets/img/h.jpg')}}" alt=""></a>
                                    </div>
                                </li>
                                <li class="span3">
                                    <div class="thumbnail">
                                        <a class="zoomTool" href="product_details.html"
                                            title="add to cart"><span class="icon-search"></span> QUICK VIEW</a>
                                        <a href="product_details.html"><img
                                                src="{{asset('frontend/assets/img/j.jpg')}}" alt=""></a>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <ul class="thumbnails">
                    <li class="span4">
                        <div class="thumbnail">
                            ...
                            <a class="zoomTool" href="product_details.html" title="add to cart"><span
                                    class="icon-search"></span> QUICK VIEW</a>
                            <a href="product_details.html"><img src="{{asset('frontend/assets/img/b.jpg')}}"
                                    alt=""></a>
                    ...
                    <li class="span4">
                        <div class="thumbnail">
                            <a class="zoomTool" href="product_details.html" title="add to cart"><span
                                    class="icon-search"></span> QUICK VIEW</a>
                            <a href="product_details.html"><img src="{{asset('frontend/assets/img/c.jpg')}}"
                                    alt=""></a>
                            <div class="caption cntr">
                                <p>Manicure & Pedicure</p>
                                <p><strong> $22.00</strong></p>
                    ...
                    <li class="span4">
                        <div class="thumbnail">
                            <a class="zoomTool" href="product_details.html" title="add to cart"><span
                                    class="icon-search"></span> QUICK VIEW</a>
                            <a href="product_details.html"><img src="{{asset('frontend/assets/img/a.jpg')}}"
                                    alt=""></a>
                            <div class="caption cntr">
                                <p>Manicure & Pedicure</p>
                                <p><strong> $22.00</strong></p>
                ...
                <ul class="thumbnails">
                    <li class="span4">
                        <div class="thumbnail">
                            <a class="zoomTool" href="product_details.html" title="add to cart"><span
                                    class="icon-search"></span> QUICK VIEW</a>
                            <a href="product_details.html"><img src="{{asset('frontend/assets/img/d.jpg')}}"
                                    alt=""></a>
                            <div class="caption">
                    ...
                    <li class="span4">
                        <div class="thumbnail">
                            <a class="zoomTool" href="product_details.html" title="add to cart"><span
                                    class="icon-search"></span> QUICK VIEW</a>
                            <a href="product_details.html"><img src="{{asset('frontend/assets/img/e.jpg')}}"
                                    alt=""></a>
                            <div class="caption">
                                <h5>Manicure & Pedicure</h5>
                                <h4>
                    ...
                    <li class="span4">
                        <div class="thumbnail">
                            <a class="zoomTool" href="product_details.html" title="add to cart"><span
                                    class="icon-search"></span> QUICK VIEW</a>
                            <a href="product_details.html"><img src="{{asset('frontend/assets/img/f.jpg')}}"
                                    alt="" /></a>
                            <div class="caption">
                                <h5>Manicure & Pedicure</h5>
                                <h4>
