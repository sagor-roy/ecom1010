<nav class="navbar py-3">
    ...
    <div class="container-fluid">
        ...
        <div class="right_content text-right">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-xl">
                    <div class="dropdown_heading">
                        ...
                        <a href="#" class="list-group-item active">
                            <div class="row">
                                <div class="col-3">
                                    <img class="img-fluid rounded-circle" src="{{asset('backend/vendor/img/avata/team-4.jpg')}}" alt="">
                                </div>
                                <div class="col-9">
                                    <div class="clearfix">
            ...
            <div class="btn-group">
                <button class="dropdown-toggle notification" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="fas fa-comment-dots"></i> <sup class="bg-danger px-1  rounded-circle">9</sup>
                </button>
